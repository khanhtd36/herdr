...
impl ClientShellState {
    ...
    pub(super) fn endpoint_method_for_action(
        ...
        use crate::api::schema::{
            EmptyParams, Method, PaneDirection, PaneFocusDirectionParams, PaneResizeParams,
        ...
        match action {
            ...
            KeybindAction::ClearScreen => Some(Method::PaneClear(PaneTarget {
                pane_id: focused_pane.clone()?,
            })),
            KeybindAction::MarkPane => Some(Method::PaneMark(EmptyParams {})),
            KeybindAction::UnmarkPane => Some(Method::PaneUnmark(EmptyParams {})),
            KeybindAction::SwapMarkedPane => Some(Method::PaneSwapMarked(EmptyParams {})),
