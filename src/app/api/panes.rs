...
use crate::api::schema::{
    EmptyParams, EventData, EventEnvelope, EventKind, PaneClearAgentAuthorityParams,
...
impl App {
    ...
    pub(super) fn handle_pane_unmark(&mut self, id: String, _params: EmptyParams) -> String {
        self.state.unmark_pane();
        encode_success(id, ResponseResult::Ok {})
    }

    pub(super) fn handle_pane_swap_marked(&mut self, id: String, _params: EmptyParams) -> String {
        ...
        if self.state.swap_marked_pane() {
            self.state.mark_session_dirty();
            self.schedule_session_save();
